...
var getOrCreateTarget = require('./handlers/getOrCreateTarget')
var getOrEditTarget = require('./handlers/getOrEditTarget')
var makeDecision = require('./handlers/makeDecision')
...
router.set('/api/targets', getOrCreateTarget)
router.set('/api/target/:id', getOrEditTarget)
router.set('/route', makeDecision)
...
function handler (req, res) {
  ...
  req.on('end', () => {
    req.body = data.length !== 0 ? JSON.parse(data) : null
